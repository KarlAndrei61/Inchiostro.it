            ...
            <div class="col-12 col-md-8">
                <form action="{{route('article.store')}}" method="POST" class="card p-5 shadow" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <span class="small text-muted fst-italic">L'immagine deve essere in formato JPG e non superare 1MB.</span>
                        @error('image')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="category" class="form-label">Corpo del testo</label>
