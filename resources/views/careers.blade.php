<x-layout>
    ...
    <!-- div.container.my-5>div.row>div.col-12.col-md-6>form.card.p-5.shadow -->
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <form action="{{route('careers.submit')}}" method="POST" class="card p-5 shadow">
                    ...
                    <div class="mb-3">
                        <label for="message" class="form-label">Perchè vuoi candidarti per questo ruolo? Raccontalo</label>
            ...
            <div class="col-12 col-md-6 p-5">
                ...
                <p>Scegliendo di lavorare come amministratore, ti occuperai di gestire le richieste di lavoro e di aggiungere e modificre le categorie.</p>
